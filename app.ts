...
let career: String = "Atomic Student";
let description: String = "I want to create the code for consciousness.";

let myInterests:Array<String> = ["Coding", "Pool", "Games", "Swimming"];
let myName: String = "Dustin Parker";
