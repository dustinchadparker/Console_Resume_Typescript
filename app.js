var career = "Atomic Student";
var description = "I want to create the code for consciousness.";
var myInterests = ["Coding", "Pool", "Games", "Swimming"];
var myName = "Dustin Parker";
